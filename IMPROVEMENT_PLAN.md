...
- Added side-result filtering controls in train/iterate with explicit
  overrides; default auto mode now keeps full side data (`any`) to avoid
  over-pruning Black-side supervision.
