...
PRESETS = {
    ...
    "daily": {
        ...
        "args": [
            ...
            "--games", "80",
            "--curriculum-games", "80",
            "--black-focus-games", "90",
            "--human-seed-games", "50",
            "--simulations", "300",
            "--curriculum-simulations", "100",
            "--black-focus-simulations", "150",
    ...
    "overnight": {
        ...
        "args": [
            "--iterations", "6",
            "--games", "100",
            "--curriculum-games", "120",
            "--black-focus-games", "140",
            "--human-seed-games", "80",
            "--simulations", "700",
            "--curriculum-simulations", "300",
            "--black-focus-simulations", "400",
            "--human-seed-simulations", "500",
            "--epochs", "12",
            "--warmup-epochs", "3",
            "--warmup-start-factor", "0.1",
